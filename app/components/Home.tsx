    ...
    <div className="text-blue-100 flex flex-col justify-start md:justify-center min-h-screen pt-20 md:pt-0">
      <div className="relative z-20 text-center mt-4 md:mt-0 flex flex-col h-full">
        ...
        <div className="overflow-y-auto max-h-[calc(100vh-250px)] mt-4 pb-4 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto items-center justify-items-center">
            <div className="flex flex-col items-center p-6 bg-gray-900 bg-opacity-40 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full">
            ...
            <div className="flex flex-col items-center p-6 bg-gray-900 bg-opacity-40 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full">
              ...
              <h3 className="text-xl font-semibold text-blue-300">Elite Engineering</h3>
              <p className="text-sm text-center text-blue-100">Frontend, Backend</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-gray-900 bg-opacity-40 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full">
              <Cloud className="w-10 h-10 text-blue-300 mb-2" />
              <h3 className="text-xl font-semibold text-blue-300">Cloud Computing</h3>
