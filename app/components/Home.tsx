  ...
  return (
    <div className="text-blue-100 flex flex-col justify-start md:justify-center min-h-screen pt-20 md:pt-0">
      <div className="relative z-20 text-center mt-4 md:mt-0 flex flex-col h-full">
        ...
        <h2 className="text-2xl md:text-4xl text-yellow-400 mb-4 md:mb-6">Senior Full Stack Engineer</h2>
        ...
        <div className="overflow-y-auto max-h-[calc(100vh-250px)] mt-4 pb-4 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto items-center justify-items-center">
            <div className="flex flex-col items-center p-4 bg-gray-900 bg-opacity-30 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full border border-transparent animate-glow-chase">
            ...
            <div className="flex flex-col items-center p-4 bg-gray-900 bg-opacity-30 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full border border-transparent animate-glow-chase animation-delay-2250">
            ...
            <div className="flex flex-col items-center p-4 bg-gray-900 bg-opacity-30 backdrop-blur-sm rounded-xl max-w-[350px] md:max-w-none w-full border border-transparent animate-glow-chase animation-delay-2500">
