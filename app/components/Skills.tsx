...
export function Skills() {
  const InfographicSummary = () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
      <div className="flex flex-col items-center p-6 bg-gray-900 bg-opacity-40 backdrop-blur-sm rounded-xl w-full">
  ...
  return (
    <div className="text-blue-100 pt-20">
      <div className="relative z-20">
        ...
        <div className="max-w-5xl mx-auto px-12 overflow-y-auto max-h-[calc(100vh-180px)] pb-10">
          <InfographicSummary />
        </div>
      </div>
    </div>
